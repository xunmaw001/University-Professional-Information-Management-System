    ...
    <div class="plate">
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in kechengRecommend" v-bind:key="index">
                <a target="_self" :href="'../kecheng/detail.jsp?id='+item.id">
                  <div class="posi-img">
                    <img :src="item.kcPhoto" width="385" height="220" />
                  </div>
                  <div class="remark">
                    <h5>{{item.name}}</h5>
                  </div>
      ...
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in zhuanyeRecommend" v-bind:key="index">
                <a target="_self" :href="'../zhuanye/detail.jsp?id='+item.id">
                  <div class="posi-img">
                    <img :src="item.zyPhoto" width="385" height="220" />
                  </div>
                  <div class="remark">
                    <h5>{{item.name}}</h5>
                  </div>
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request('news/list', 'get', {
        ...
        http.request(`kecheng/page`, 'get', {
            page: 1,
            limit: 6
        }, function(res) {
            vue.kechengRecommend = res.data.list;
        });

        http.request(`zhuanye/page`, 'get', {
            page: 1,
            limit: 6
        }, function(res) {
            vue.zhuanyeRecommend = res.data.list;
        });
    });
  </script>
</body>
