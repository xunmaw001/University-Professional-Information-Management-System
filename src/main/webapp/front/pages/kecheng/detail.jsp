...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function () {
        ...
        http.request(
            `zhuanye/page`, 'get', {}, function (res) {
                if (res && res.code === 0) {
                    this.zyTypesSelectSearch = res.data.list;
                } else {
        ...
        http.request(`${vue.detailTable}/info/` + id, 'get', {}, function (res) {
            ...
            // 轮播图片
            vue.swiperList = vue.detail.kcPhoto ? vue.detail.kcPhoto.split(",") : [];
            var swiperItemHtml = '';
            ...
            var zyTypesSelect = this.zyTypesSelectSearch;
            for (var i = 0; i < zyTypesSelect.length; i++) {
                if(zyTypesSelect[i].id == vue.detail.zyTypes){
                    vue.detail.zyTypes = zyTypesSelect[i].name;
                }
            }
