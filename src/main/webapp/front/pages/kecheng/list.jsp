          ...
          <form class="layui-form">
            <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-input-inline">
                <input type="text" name="name" id="name" placeholder="课程名称" autocomplete="off" class="layui-input">
              </div>
            </div>   
            ...
            <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
              ...
              <button v-if="isAuth('kecheng','新增')" @click="jump('../kecheng/add.jsp')" type="button" class="layui-btn btn-theme">
          ...
          <ul class="after">
            <li v-for="(item,index) in dataList" v-bind:key="index">
              <a target="_self" :href="'../kecheng/detail.jsp?id='+item.id">
                <div class="posi-img">
                  <img :src="item.kcPhoto?item.kcPhoto.split(',')[0]:''" width="385px" height="220px" />
                </div>
                <div class="remark">
                  <h5>{{item.name}}</h5>
                </div>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        // 获取列表数据
        http.request('kecheng/page', 'get', param, function(res) {
