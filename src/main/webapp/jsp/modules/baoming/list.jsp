                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                ...
                                <button onclick="deleteMore()" type="button" class="btn btn-danger 删除">批量取消报名</button>
                            ...
                            <table id="tableId" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th onclick="sort('xsTypes')">学生名称</th>
...
<script>
    ...
    // 删除
    function remove(id) {
        var mymessage = confirm("真的要取消报名吗？");
        if (mymessage == true) {
            var paramArray = [];
            if (id == ids) {
                paramArray = id;
    ...
    function crossTable(id, crossTableName) {
        ...
        window.sessionStorage.setItem('crossTableName', "baoming");
