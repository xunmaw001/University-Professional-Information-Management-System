                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            <div class="form-row">
                                   ...
                                   <div class="form-group col-md-6">
                                       <label>课程图片</label>
                                       <img id="kcPhotoImg" src="" width="100" height="100">
                                       <input name="file" type="file" id="kcPhotoupload"
                                              class="form-control-file">
                                       <input name="kcPhoto" id="kcPhoto" type="hidden">
                                   </div>
...
<script>
    ...
    // 文件上传
    function upload() {
        $('#kcPhotoupload').fileupload({
            url: baseUrl + 'file/upload',
            headers: {token: window.sessionStorage.getItem("token")},
            dataType: 'json',
            done: function (e, data) {
                var photoUrl= baseUrl + 'file/download?fileName=' + data.result.file;
                document.getElementById('kcPhotoImg').setAttribute('value',photoUrl);
                document.getElementById('kcPhoto').setAttribute('value',photoUrl);
            }
        });
    ...
    //查询当前页面下所有列表
        function zyTypesSelect() {
            //填充下拉框选项
            http("zhuanye/page?page=1&limit=100", "GET", {}, (res) => {
                if(res.code == 0){
    ...
    //图片显示
    function showImg() {
        $("#kcPhotoImg").attr("src",ruleForm.kcPhoto);
    }
