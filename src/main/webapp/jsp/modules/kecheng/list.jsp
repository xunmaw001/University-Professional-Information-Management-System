                        ...
                        <div class="table-responsive mb-3">
                            ...
                            <table id="tableId" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th onclick="sort('zyTypes')">所属专业</th>
                                    <th>课程图片</th>
                                    <th onclick="sort('noticeContent')">课程描述</th>
                                    <th>操作</th>
                                </tr>
                                </thead>
                                <tbody>
...
<script>
    ...
    function setDataRow(item, number) {
        ...
        var kcPhotoCell = document.createElement('td');

        var kcPhotoImg = document.createElement('img');
        kcPhotoImg.setAttribute('src', item.kcPhoto);
        kcPhotoImg.setAttribute('height', 100);
        kcPhotoImg.setAttribute('width', 100);
        kcPhotoCell.appendChild(kcPhotoImg);
        row.appendChild(kcPhotoCell);
    ...
    function crossTable(id, crossTableName) {
        ...
        window.sessionStorage.setItem('crossTableName', "kecheng");
