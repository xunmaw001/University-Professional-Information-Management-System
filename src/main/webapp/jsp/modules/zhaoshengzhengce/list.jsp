                        ...
                        <div class="table-responsive mb-3">
                            ...
                            <table id="tableId" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th onclick="sort('noticeContent')">招生政策</th>
                                    <th>操作</th>
                                </tr>
                                </thead>
                                <tbody>
...
<script>
    ...
    var tableName = "zhaoshengzhengce";
    var pageType = "list";
    var searchForm = {key: ""};
    var pageIndex = 1;
    var pageSize = 10;
    ...
    function getDataList() {
        http("zhaoshengzhengce/page", "GET", {
            page: pageIndex,
            limit: pageSize,
            sort: sortColumn,
            order: sortOrder,
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("zhaoshengzhengce/delete", "POST", paramArray, (res) => {
                if(res.code == 0
        )
            {
                getDataList();
    ...
    function getSum(colName) {
        http("zhaoshengzhengce" + colName, "GET", {
    ...
    function crossTable(id, crossTableName) {
        ...
        window.sessionStorage.setItem('crossTableName', "zhaoshengzhengce");
