                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>培养目标</label>
                                        <input id="aobjective" name="aobjective" class="form-control"
                                               placeholder="培养目标">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>就业前景</label>
                                        <input id="prospects" name="prospects" class="form-control"
                                               placeholder="就业前景">
                                    </div>
                                   <div class="form-group col-md-6">
                                       <label>专业图片</label>
                                       <img id="zyPhotoImg" src="" width="100" height="100">
                                       <input name="file" type="file" id="zyPhotoupload"
                                              class="form-control-file">
                                       <input name="zyPhoto" id="zyPhoto" type="hidden">
                                   </div>
...
<script>
    ...
    // 文件上传
    function upload() {
        $('#zyPhotoupload').fileupload({
            url: baseUrl + 'file/upload',
            headers: {token: window.sessionStorage.getItem("token")},
            dataType: 'json',
            done: function (e, data) {
                var photoUrl= baseUrl + 'file/download?fileName=' + data.result.file;
                document.getElementById('zyPhotoImg').setAttribute('value',photoUrl);
                document.getElementById('zyPhoto').setAttribute('value',photoUrl);
            }
        });
    ...
    function dataBind() {
        ...
        $("#aobjective").val(ruleForm.aobjective);
        $("#prospects").val(ruleForm.prospects);
    ...
    //图片显示
    function showImg() {
        $("#zyPhotoImg").attr("src",ruleForm.zyPhoto);
    }
